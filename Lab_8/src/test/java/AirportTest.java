...
import Planes.models.ClassificationLevel;
import Planes.models.ExperimentalTypes;
import Planes.models.MilitaryType;
...
public class AirportTest {
    ...
    public void testGetTransportMilitaryPlanes() {
        ...
        Assert.assertEquals(isMilitary, true);
    }
    ...
    @Test
    public void testIsSortedCorrcetly() {
        Airport airport = new Airport(planes);
    ...
    public void testHasAtLeastOneBomberInMilitaryPlanes() {
        ...
        Assert.assertTrue(hasAtLeastOneBomber);
    }
