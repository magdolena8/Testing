...
public class Airport {
    ...
    public List<PassengerPlane> getPassangerPlanes() {
        List<PassengerPlane> passangerPlanesList = new ArrayList<>();
        for (Plane plane : planes) {if (plane instanceof PassengerPlane) {passangerPlanesList.add((PassengerPlane) plane);}}
        return passangerPlanesList;
    }
